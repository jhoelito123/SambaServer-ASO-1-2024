...
#    May 11, 2024 07:16:53 PM -04  platform: Windows NT
...
class intro:
    def __init__(self, top=None):
        ...
        photo_location = os.path.join(_location,"suse logo.png")
        global _img0
        ...
        photo_location = os.path.join(_location,"Samba medium.png")
        global _img1
        ...
        photo_location = os.path.join(_location,"pyc little.png")
        global _img2
        ...
        self.entryUser_1 = tk.Entry(self.top)
        self.entryUser_1.place(relx=0.264, rely=0.684, height=20, relwidth=0.52)
        self.entryUser_1.configure(background="white")
        self.entryUser_1.configure(disabledforeground="#a3a3a3")
        self.entryUser_1.configure(font="-family {Courier New} -size 10")
        self.entryUser_1.configure(foreground="black")
        self.entryUser_1.configure(highlightbackground="#d9d9d9")
        self.entryUser_1.configure(highlightcolor="#000000")
        self.entryUser_1.configure(insertbackground="#000000")
        self.entryUser_1.configure(selectbackground="#d9d9d9")
        self.entryUser_1.configure(selectforeground="black")
